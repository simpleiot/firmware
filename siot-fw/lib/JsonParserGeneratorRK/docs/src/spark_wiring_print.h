 ...
 *
 * Various classes include serial, TCP network streams, and files inherit from
 * this and can use these methods.
 */
class Print {
private:
    int write_error;
...
public:
   ...
   *
   * @param buffer pointer to the buffer. The data does not need to be
   * null-terminated.
   ...
   */
    ...
    /**
   * @brief Print a null-terminated array of char variables (a c-string) to the
   * stream or file
   */
   ...
   */
    ...
    /**
   * @brief Print an unsigned char (byte value, 8 bits) in the specified base to
   * the stream or file.
   *
   * @param value The value to print.
   * @param base The base to print. Default is DEC (decimal). Other values are
   * HEX (hexadecimal), OCT (octal), and BIN (binary).
   */
    size_t print(unsigned char value, int base = DEC);

    /**
   * @brief Print an int (32 bit integer) the specified base to the stream or
   * file.
   *
   * @param value The value to print.
   * @param base The base to print. Default is DEC (decimal). Other values are
   ...
   */
    ...
    /**
   * @brief Print an unsigned int (32 bit unsigned integer) the specified base
   ...
   */
    ...
    /**
   * @brief Print a long (32 bit integer) the specified base to the stream or
   * file.
   *
   * @param value The value to print.
   * @param base The base to print. Default is DEC (decimal). Other values are
   ...
   */
    ...
    /**
   * @brief Print a unsigned long (32 bit unsigned integer) the specified base
   * to the stream or file.
   *
   * @param value The value to print.
   * @param base The base to print. Default is DEC (decimal). Other values are
   ...
   *
   * @param value The value to print.
   * @param dec The number of decimal places to include for the fractional part.
   * Default: 2
   */
   ...
   */
    ...
    /**
   * @brief Print a null-terminated array of char variables (a c-string) plus a
   * CRLF end-of-line terminator to the stream or file.
   */
    size_t println(const char[]);

    /**
   * @brief Print a single character plus a CRLF end-of-line terminator to the
   * stream or file.
   */
    size_t println(char value);

    /**
   * @brief Print an unsigned char (byte value. 8 bits) in the specified base
   * plus a CRLF end-of-line terminator to the stream or file.
   *
   * @param value The value to print.
   * @param base The base to print. Default is DEC (decimal). Other values are
   * HEX (hexadecimal), OCT (octal), and BIN (binary).
   */
    ...
    /**
   * @brief Print an int (32 bit integer) the specified base to plus a CRLF
   * end-of-line terminator the stream or file.
   *
   * @param value The value to print
   * @param base The base to print. Default is DEC (decimal). Other values are
   * HEX (hexadecimal), OCT (octal), and BIN (binary).
   ...
   */
    ...
    /**
   * @brief Print a long (32 bit signed integer) the specified base plus a CRLF
   * end-of-line terminator to the stream or file.
   *
   * @param value The value to print
   * @param base The base to print. Default is DEC (decimal). Other values are
   * HEX (hexadecimal), OCT (octal), and BIN (binary).
   ...
   */
    ...
    /**
   * @brief Print a double floating point value plus a CRLF end-of-line
   * terminator to the stream or file.
   *
   * @param value The value to print.
   * @param dec The number of decimal places to include for the fractional part.
   * Default: 2
   */
    ...
    /**
   * @brief Print an object derived from Printable plus a CRLF end-of-line
   * terminator to the stream or file
   */
   ...
   */
    ...
    /**
   * @brief Print using printf-style formatting plus a CRLF end-of-line
   * terminator to the stream or file
   *
   * @param format printf-style formatting string
   *
